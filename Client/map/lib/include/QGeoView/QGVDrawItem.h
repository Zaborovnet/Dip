...
public:
    ...
    virtual QPainterPath projShapeText()const = 0;;
    virtual void projPaint(QPainter* painter) = 0;
    virtual void projPaintText(QPainter* painter)=0;
    virtual QPointF projAnchor() const;
    virtual QPointF projAnchorText() const;
...
private:
    ...
    QScopedPointer<QGVMapQGItemText> mQGDrawItemText;
