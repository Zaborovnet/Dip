...
void BackgroundDemo::onInit()
{
    ...
    const QString customURI2 = "http://localhost:8080/%1/%2/%3.png";
    const QString customURI3 = "http://192.168.56.3:80/hot/${z}/${x}/${y}.png";
    const QList<QPair<QString, QGVLayer*>> layers = {
        ...
        { "Python server", new QGVLayerOSM(customURI2) },
        { "tile_server", new QGVLayerOSM(customURI3) },
