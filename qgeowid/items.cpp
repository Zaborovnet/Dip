...
void ItemsDemo::onInit()
{
    ...
    for (auto pair : colors) {
         ...
         */
        for (int i = 0; i < 100; i++) { // количество объектов выводимых на карту
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
...
{
    return QGV::GeoRect(QGV::GeoPos(46.419424, 28.888922), QGV::GeoPos(46.282726, 29.119152)); //точка перенаправления на заданные айтемы
    ;
}
